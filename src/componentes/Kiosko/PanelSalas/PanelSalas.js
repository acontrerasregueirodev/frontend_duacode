...
const guardarReservaEditada = async (evento) => {
    ...
    try {
        ...
        await axios.put(`http://localhost:8000/api/sedes/reservas/${reservaParaEditar.id}/`, reservaActualizada, {
            withCredentials: true,
            headers: {
                'X-CSRFToken': tokenCsrf
            }
    ...
    const manejarCreacionReserva = async (evento) => {
        ...
        try {
            ...
            const respuesta = await axios.post('http://localhost:8000/api/sedes/reservas/', nuevaReserva, {
                withCredentials: true,
                headers: {
                    'X-CSRFToken': tokenCsrf
                }
