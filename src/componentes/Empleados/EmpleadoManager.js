    ...
    <div>
      ...
      <form onSubmit={handleSubmit}>
        ...
        <input
          ...
          onChange={(e) =>
            setFormData({ ...formData, apellido_1: e.target.value })
          }
          required
        />
        <input
          ...
          onChange={(e) =>
            setFormData({ ...formData, apellido_2: e.target.value })
          }
        />
        <input
          type="email"
        ...
        <input
          type="date"
          value={formData.fecha_contratación}
          onChange={(e) =>
            setFormData({ ...formData, fecha_contratación: e.target.value })
          }
          required
        />
        <input
          ...
          onChange={(e) =>
            setFormData({ ...formData, cumpleaños: e.target.value })
          }
          required
        />
        <input
